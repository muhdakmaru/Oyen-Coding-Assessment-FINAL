        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <p className="text-base font-semibold leading-7 text-indigo-600">Akmaru</p>
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Oyen Insurance Coding Assesment</h1>
              <p className="mt-6 text-xl leading-8 text-gray-700">
                The home page can only be access if the users have a valid token. If the users trying to access the home page
                without the token, it will automatically redirect to the Login Page.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">Push to deploy.</strong> Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">SSL certificates.</strong> Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">Database backups.</strong> Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et
